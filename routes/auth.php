...
Route::middleware('guest')->group(function () {
    ...
    Route::post('password/reset', [PasswordResetLinkController::class, 'resetPassword'])->name('password.update');

    
 


    // Route::post('{type}/reset-password', [NewPasswordController::class, 'store'])
    //             ->name('password.store');
