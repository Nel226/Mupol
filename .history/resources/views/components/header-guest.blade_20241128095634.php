            ...
            <div class="container">
                <div class="inner">
                    <div class="row items-center justify-between">
                        ...
                        <div class="col-lg-2 col-12 flex items-center justify-end">
                            <div class="get-quote">
                                @if (!Auth::guard('adherent')->check() && !Auth::guard('partenaire')->check())
                                    <a href="{{ route('user.login') }}">
                                        <x-primary-button class="!bg-white !text-primary1 px-2 py-1 text-xs items-center">
                                ...
                                @else
                                    @if (Auth::guard('adherent')->check())
                                        <form action="{{ route('adherent.logout') }}" method="post" class="flex">
                                            @csrf
                                            <x-primary-button class="!bg-white !text-primary1 px-2 py-1 text-xs items-center">
                                                <i class="fa fa-unlock-alt mr-1"></i> Déconnexion
                                            </x-primary-button>
                                        </form>
