        ...
        <section class="container mx-auto px-6">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 mx-auto max-w-4xl">
                <div class="mb-6 text-center">
                    <h2 class="text-xl font-bold text-gray-800 dark:text-white">Ajouter une prestation</h2>
                ...
                <form action="{{ route('adherents.nouvelle-prestation.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4 max-w-2xl mx-auto">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="contactPrestation" id="contactPrestation" class="block w-full p-2 mb-4 text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" required>
                            </div>
                            <div>

                                <label for="contactPrestation" class="block text-gray-700 dark:text-gray-300 font-semibold">Acte</label>
        
                                <select id="acte" name="acte" class="acte-select block w-full p-2 mb-4 text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
                    ...
                    <div class="text-center">
                        <button type="submit" class="bg-indigo-600 text-white px-6 py-2 rounded-md font-semibold shadow-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-200 ease-in-out">Ajouter prestation</button>
                    </div>
                </form>
            </div>
        </section>
