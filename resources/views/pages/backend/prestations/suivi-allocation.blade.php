        ...
        <div class="md:p-6 p-2 mx-auto mt-4 bg-white rounded-lg shadow-lg">
            ...
            <div class="">
                <div id="tab-recapitulatif-content" class="mt-2 tab-content">
                    <h1 class="pb-3 text-xl font-bold text-center underline ">Suivi des allocations pour {{ $currentYear }}</h1>
                   
                    <div class="flex items-center justify-between py-4 text-sm">
                        <div class="flex gap-3 ">

                            <form method="GET" action="{{ route('suivi-allocation') }}"  onsubmit="showSpinner()">
                    ...
                    <div class="grid grid-cols-1 gap-4 mb-6 md:grid-cols-2">
                        ...
                        <!-- Graphique Nombre d'allocations -->
                        <div>
                            <span>Nombre d'allocations (B)</span>
                            <canvas id="allocationsChart"></canvas>
                        </div>

                        {{--  <!-- Graphique Coût total des allocations -->
                        <div>
                            <h3>Coût total des allocations (E)</h3>
                    ...
                    <script>
                        ...
                        const allocationsData = @json(array_values($data['Nombre d’allocations (B)']));
                        const prestationsCostData = @json(array_values($data['Coût total des allocations (E)']));
                        const avgAllocationCostData = @json(array_values($data['Coût moyen mensuel d’une allocation (F)']));
                        ...
                        const ctx2 = document.getElementById('allocationsChart').getContext('2d');
                        ...
                        new Chart(ctx1, {
                            ...
                            data: {
                                labels: months,
                                datasets: [{
                                    label: 'Coût des allocations',
                                    data: avgAllocationCostData.slice(0, 12), // Exclure les totaux et moyennes
                        ...
                        new Chart(ctx2, {
                            ...
                            data: {
                                labels: months,
                                datasets: [{
                                    label: 'Nombre d’allocations',
                                    data: allocationsData.slice(0, 12), // Exclure les totaux et moyennes
                        ...
                        new Chart(ctx3, {
                            ...
                            data: {
                                labels: months,
                                datasets: [{
                                    label: 'Coût total des allocations',
                    ...
                    const tableSuivi = new Tabulator("#prestations-table", {
                        ...
                        printHeader: `
                            <div style="text-align:center; margin-bottom:20px;">
                                ...
                                <h2 style="margin:0; font-size:20px; color:#111827; font-weight:bold;">Tableau de suivi des Allocations</h2>
