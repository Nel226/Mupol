<x-app-layout>
    <div class="w-full flex gap-4">
                           ...
                           <div class="flex-col gap-1 flex">
                               <div class="flex-col flex p-3 bg-white rounded-lg">
                                   <div class="h-5 gap-3 flex">
                                       ...
                                       <h2 class="text-gray-500 text-sm font-medium leading-snug">Vote</h2>
                                   </div>
                               </div>
                           </div>
                       </a>
        ...
        <div class="col-span-2 p-4 sm:ml-64 w-full h-full md:block hidden">
...
<button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
 ...
 <script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (toggleButton && sidebar) {
            toggleButton.addEventListener('click', () => {
                sidebar.classList.toggle('-translate-x-full'); // Ajoute/retire la classe pour masquer/afficher
            });
        }
    });
</script>
    ...
    @endif
    <x-content-page class="p-4 sm:ml-64">
