        ...
        <div class="md:p-6 p-2 mx-auto mt-4 bg-white rounded-lg shadow-lg">
            ...
            <div class="p-6 mx-auto bg-white rounded-lg shadow-lg ">
                <div id="tab-recapitulatif-content" class="mt-2 tab-content">
                    <h1 class="pb-3 text-xl font-bold text-center underline ">Suivi des hospitalisations pour {{ $currentYear }}</h1>

                    <div class="flex items-center justify-between py-4 text-sm">
                        <div class="flex gap-3 ">

                            <form method="GET" action="{{ route('suivi-hospitalisation') }}"  onsubmit="showSpinner()">
                    ...
                    <div class="flex overflow-x-auto gap-4 mb-6">
                        ...
                        <!-- Graphique Nombre d’hospitalisations -->
                        <div class="flex-shrink-0 w-1/2">
                            <span>Nombre d’hospitalisations (B)</span>
                            <canvas id="hospitalisationsChart"></canvas>
                        </div>

                        <!-- Graphique Coût total des hospitalisations -->
                        <div class="flex-shrink-0 w-1/2">
                            <h3>Coût total des hospitalisations (E)</h3>
                    ...
                    <script>
                        ...
                        const ctx2 = document.getElementById('hospitalisationsChart').getContext('2d');
                        ...
                        new Chart(ctx2, {
                            ...
                            data: {
                                ...
                                datasets: [{
                                    ...
                                    data: hospitalisationsData.slice(0, 12), // Exclure les totaux et moyennes
                        ...
                        new Chart(ctx3, {
                            ...
                            data: {
                                labels: months,
                                datasets: [{
                                    label: 'Coût total des hospitalisations',
                                ...
                                {
                                    label: 'Coût moyen mensuel d’une hospitalisation (F)',
                ...
                <script>
                    ...
                    const tableSuivi = new Tabulator("#prestations-table", {
                        ...
                        printHeader: `
                            <div style="text-align:center; margin-bottom:20px;">
                                ...
                                <h2 style="margin:0; font-size:20px; color:#111827; font-weight:bold;">Tableau de suivi des Hospitalisations</h2>
                    ...
                    document.getElementById('export-suivi-hospitalisation').addEventListener('click', function() {
                        tableSuivi.download("xlsx", `Suivi_hospitalisations_${currentYear}.xlsx`, {});
                    });
                </script>
                <style>
                    @media print {
