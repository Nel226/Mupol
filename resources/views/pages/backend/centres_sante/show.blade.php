    ...
    <x-content-page>
        ...
        <div class="flex-1 p-6">
            ...
            <div class="p-6 mx-auto mt-4 bg-white min-h-screen rounded-b-lg shadow-lg">
                <section class="bg-white dark:bg-gray-900 py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                    <!-- Image du centre de santé -->
                    <div>
                        <img class="w-full dark:hidden" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/cta/cta-dashboard-mockup.svg" alt="dashboard image">
                        {{-- <img class="w-full dark:hidden rounded-lg shadow-lg" src="http://127.0.0.1:8005/storage/{{ $centre->photo }}" alt="Centre de santé image"> --}}
                        <img class="w-full hidden dark:block rounded-lg shadow-lg" src="{{ Storage::url($centre->photo) }}" alt="Centre de santé image">
                    </div>
