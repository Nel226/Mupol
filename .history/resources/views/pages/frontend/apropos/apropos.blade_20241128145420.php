			...
			<div class="container">
				<div class="inner">
					<div class="row"> 
						<div class="col-lg-6">
							<div class="contact-us-left">
                                <img src="{{ asset('images/accueil/accueil8.jpg') }}" alt="Photo PCA">
						...
						<div class="col-lg-6">
							<div class="contact-us-form !pb-0">
								<h2>A propos</h2>
								<p>La Mutuelle de la Police Nationale (MU-POL)</p>
                    ...
                    <div class="row"> 
						...
						<div class="col-lg-6">
							<div class="contact-us-left">
                                <img src="{{ asset('images/actualites/actualite5.jpg') }}" alt="Photo PCA">
