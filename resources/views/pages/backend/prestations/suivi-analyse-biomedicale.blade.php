        ...
        <div class="md:p-6 p-2 mx-auto mt-4 bg-white rounded-lg shadow-lg">
            <div class="">
                <div id="tab-recapitulatif-content" class="mt-2 tab-content">
                    <h1 class="pb-3 text-xl font-bold text-center underline ">Suivi des analyses biomédicales pour {{ $currentYear }}</h1>
                   
                    <div class="flex items-center justify-between py-4 text-sm">
                        <div class="flex gap-3 ">

                            <form method="GET" action="{{ route('suivi-analyse-biomedicale') }}"  onsubmit="showSpinner()">
                    ...
                    <div class="grid grid-cols-1 gap-4 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            <span>Coût total des analyses biomédicales (E)</span>
                            <canvas id="beneficiairesChart"></canvas>
                        </div>

                        <!-- Graphique Nombre des analyses biomédicales -->
                        <div>
                            <span>Nombre d&apos;analyses biomédicales (B)</span>
                            <canvas id="analysesBiomedicalesChart"></canvas>
                        </div>

                        {{--  <!-- Graphique Coût total des analyses biomédicales -->
                        <div>
                            <h3>Coût total des analyses biomédicales (E)</h3>
                    ...
                    <script>
                        ...
                        const analysesBiomedicalesData = @json(array_values($data['Nombre d’analyses biomédicales (B)']));
                        const prestationsCostData = @json(array_values($data['Coût total des analyses biomédicales (E)']));
                        const avgAnalysesBiomedicalesCostData = @json(array_values($data['Coût moyen mensuel d’une analyse biomédicale (F)']));
                        ...
                        const ctx2 = document.getElementById('analysesBiomedicalesChart').getContext('2d');
                        ...
                        new Chart(ctx1, {
                            ...
                            data: {
                                labels: months,
                                datasets: [{
                                    label: 'Nombre de analyses biomédicales',
                                    data: avgAnalysesBiomedicalesCostData.slice(0, 12), 
                        ...
                        // Graphique Nombre de analyses biomédicales
                        new Chart(ctx2, {
                            type: 'bar',
                            data: {
                                labels: months,
                                datasets: [{
                                    label: 'Nombre des analyses biomédicales',
                                    data: analysesBiomedicalesData.slice(0, 12), 
                        ...
                        new Chart(ctx3, {
                            ...
                            data: {
                                labels: months,
                                datasets: [{
                                    label: 'Coût total des analyses biomédicales',
                ...
                <script>
                    ...
                    const tableSuivi = new Tabulator("#prestations-table", {
                        ...
                        printHeader: `
                            <div style="text-align:center; margin-bottom:20px;">
                                ...
                                <h2 style="margin:0; font-size:20px; color:#111827; font-weight:bold;">Tableau de suivi des Analyses biomédicales</h2>
                    ...
                    document.getElementById('export-suivi').addEventListener('click', function() {
                        tableSuivi.download("xlsx", `Suivi_analyses_biomedicales_${currentYear}.xlsx`, {});
                    });    
                </script>
                 <style>
                    @media print {
