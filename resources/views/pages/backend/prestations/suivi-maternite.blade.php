        ...
        <div class="md:p-6 p-2 mx-auto mt-4 bg-white rounded-lg shadow-lg">
             <div class="">
                <div id="tab-recapitulatif-content" class="mt-2 tab-content">
                    <h1 class="pb-3 text-xl font-bold text-center underline ">Suivi des maternités pour {{ $currentYear }}</h1>
                   
                    <div class="flex items-center justify-between py-4 text-sm">
                        <div class="flex gap-3 ">

                            <form method="GET" action="{{ route('suivi-maternite') }}"  onsubmit="showSpinner()">
                    ...
                    <div class="grid grid-cols-1 gap-4 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            <span>Coût total des maternités (E)</span>
                            <canvas id="beneficiairesChart"></canvas>
                        </div>

                        <!-- Graphique Nombre de maternites -->
                        <div>
                            <span>Nombre de maternites (B)</span>
                            <canvas id="maternitesChart"></canvas>
                        </div>

                        {{--  <!-- Graphique Coût total des maternites -->
                        <div>
                            <h3>Coût total des maternités (E)</h3>
                    ...
                    <script>
                        ...
                        const maternitesData = @json(array_values($data['Nombre de maternites (B)']));
                        const prestationsCostData = @json(array_values($data['Coût total des maternites (E)']));
                        const avgMaterniteCostData = @json(array_values($data['Coût moyen mensuel d’une maternite (F)']));
                        ...
                        const ctx2 = document.getElementById('maternitesChart').getContext('2d');
                        ...
                        new Chart(ctx1, {
                            ...
                            data: {
                                ...
                                datasets: [{
                                    ...
                                    data: avgMaterniteCostData.slice(0, 12), 
                        ...
                        new Chart(ctx2, {
                            ...
                            data: {
                                labels: months,
                                datasets: [{
                                    label: 'Nombre de maternites',
                                    data: maternitesData.slice(0, 12), 
                        ...
                        new Chart(ctx3, {
                            ...
                            data: {
                                labels: months,
                                datasets: [{
                                    label: 'Coût total des maternites',
                    ...
                    const tableSuivi = new Tabulator("#prestations-table", {
                        ...
                        printHeader: `
                            <div style="text-align:center; margin-bottom:20px;">
                                ...
                                <h2 style="margin:0; font-size:20px; color:#111827; font-weight:bold;">Tableau de suivi des Maternités</h2>
