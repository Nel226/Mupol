...
<body>
    <div class="container justify-normal">
        ...
        <div class="header">
            ...
            <h2>Compte MU-POL créé</h2>
        </div>

        <p>Bonjour / Bonsoir,</p>

        <p>Votre compte à la Mutuelle de la Police Nationale (MU-POL) a bien été créé.</p>

        <p>Voici vos informations de connexion :</p>
        <p><strong>Email :</strong> {{ $email }}</p>
        <p><strong>Mot de passe :</strong> {{ $generatedPassword }}</p>
        <p>Vous pouvez maintenant vous connecter à votre compte ici :
            <u>

                <a href="https://mupol.bf/login/user">https://mupol.bf/login/user</a>      
            </u>
        .</p>
