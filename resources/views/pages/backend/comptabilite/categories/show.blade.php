                            ...
                            <div class="p-3">
                                <div class="intro-y col-span-6 sm:col-span-4 md:col-span-3 2xl:col-span-2">
                                    <div class="relative rounded-md px-3 pb-2 pt-3 sm:px-5">
                                        ...
                                        <a class="mt-2 block text-sm truncate text-center font-medium" href="#">{{ $subcategorie->nom }}</a>
                                        ...
                                        <div class="absolute right-0 top-0 ml-auto mr-2 mt-3">
                                            <a href="javascript:;" class="cursor-pointer block">
                                                <div class="relative inline-block text-left">
                                                    <button id="dropdownButton-{{$subcategorie->id}}" class="inline-flex items-center justify-center text-gray-500 rounded-md focus:outline-none" aria-label="Menu" aria-haspopup="true">
                                                    ...
                                                    <div id="dropdownMenu-{{$subcategorie->id}}" class="divide-y-2 font-semibold absolute z-10 right-0 mt-2 w-40 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 hidden">
                                                        <a href="#" id="delete-button-{{ $subcategorie->id }}" class="delete-button flex items-center px-4 py-2 text-sm text-red-600 hover:bg-red-300 hover:text-white">
                                        ...
                                        <x-modal class="!z-50">
                                            <form id="delete-form" action="{{ route('categories.destroy', $subcategorie) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                        ...
                                        <script>
                                            document.addEventListener('DOMContentLoaded', function () {
                                                var dropdownButton = document.getElementById('dropdownButton-{{$subcategorie->id}}');
                                                var dropdownMenu = document.getElementById('dropdownMenu-{{$subcategorie->id}}');
                                ...
                                <div class="flex flex-col mx-auto items-center">
                                    <div>
                                        <a class="mt-2 block truncate text-center font-medium" href="{{ route('categories.show', $subcategorie->uuid) }}">
                                           <x-primary-button>
