...
<body>
    <div class="container justify-normal">
        ...
        <div class="header">
            ...
            <h2>Votre fiche de cession volontaire de salaire MU-POL</h2>
        </div>

        <p>Bonjour / Bonsoir,</p>

        <p>Veuillez télécharger votre fiche de cession volontaire de salaire en pièce jointe en ci-dessous.</p>
