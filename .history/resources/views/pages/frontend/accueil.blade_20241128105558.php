            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news">
                        <div class="news-head">
                            <img src="{{ asset('images/actualites/actualite8.jpg') }}" alt="#">
                        </div>
                        <div class="news-body">
                            <div class="news-content">
                                <div class="date">05/12/2023</div>
                                <h2><a href="blog-single.html">Processus d’opérationnalisation de la MU-POL : Le 1er Directeur Général installé.</a></h2>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news">
                        <div class="news-head">
                            <img src="{{ asset('images/actualites/actualite5.jpg') }}" alt="#">
                        </div>
                        <div class="news-body">
                            <div class="news-content">
                                <div class="date">01/06/2024</div>
                                <h2><a href="blog-single.html">Formation en protection sociale et gestion d&apos;une mutuelle sociale.</a></h2>
                                {{-- <p class="text">Lorem ipsum dolor a sit ameti, consectetur adipisicing elit, sed do eiusmod tempor incididunt sed do incididunt sed.</p> --}}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="single-news">
                        ...
                        <div class="news-body">
                            <div class="news-content">
                                ...
                                <h2><a href="blog-single.html">Les femmes de la Police nationale discute du rôle et du leadership de la gente féminine dans l&apos;armée.</a></h2>
                                {{-- <p class="text">Lorem ipsum dolor a sit ameti, consectetur adipisicing elit, sed do eiusmod tempor incididunt sed do incididunt sed.</p> --}}
                            </div>
                        </div>
                    </div>
