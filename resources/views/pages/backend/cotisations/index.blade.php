            ...
            <div class="p-6 mx-auto mt-4 bg-white rounded-lg shadow-lg ">
                    ...
                    <div class="flex items-center justify-between py-4 w-full text-sm">
                        <div class="flex gap-3 w-full ">
                            <form action="{{ route('cotisations.index') }}" class="w-full  rounded-md bg-gray-100 p-2" method="GET">
                                <label for="year" class="  font-semibold">Filtre :</label>
                                
                            
                                <label for="start_date" class="ml-4">Date de début :</label>
                                <input type="date" name="start_date" id="start_date" class="py-1 rounded-md" value="{{ request('start_date') }}">
                            
                                <label for="end_date" class="ml-4">Date de fin :</label>
                                <input type="date" name="end_date" id="end_date" class="py-1 rounded-md" value="{{ request('end_date') }}">
                            
                                <x-primary-button type="submit" class="ml-4 py-1 px-3 bg-blue-500 text-white rounded-md">
                                    Filtrer
                                </x-primary-button>
                            </form>
